...
model.add(LSTM(units=50, return_sequences= True, input_shape=(x_train.shape[1], 1))) #for memorizing the sequetial info and to feed the data back to neural network
